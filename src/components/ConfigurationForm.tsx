		...
		return (
			...
			>
				<div className="flex items-center justify-between">
					<div
						className={`flex flex-wrap items-center gap-1.5 sm:gap-2.5 text-[11.5px] sm:text-xs ${darkModeColors.textMuted}`}
					>
						<span>
					...
					<button
						type="button"
						onClick={onReset}
						className={`h-7 sm:h-8 rounded-full ${darkModeColors.resetButton} px-3 sm:px-4 text-[10.35px] sm:text-xs font-semibold transition ${darkModeColors.resetButtonHover}`}
					>
						Reset
					</button>
				</div>
