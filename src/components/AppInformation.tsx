...
export const AppInformation = () => {
	return (
		<div className={`flex flex-1 flex-col overflow-hidden rounded-3xl ${darkModeColors.border} ${darkModeColors.bgCard} shadow-lg max-h-[calc(100vh-2.75rem)] sm:max-h-[calc(100vh-3.5rem)]`}>
			<div className="flex-1 overflow-y-auto p-4 sm:p-6">
				<div className="mx-auto max-w-3xl space-y-6">
					<div>
						<h1 className={`text-2xl sm:text-3xl font-bold ${darkModeColors.textPrimary}`}>
							Korli Language Tutor
						</h1>
						<p className={`mt-2 text-sm sm:text-base ${darkModeColors.textMuted}`}>
							AI-powered language learning chat interface
						</p>
					</div>

					<div>
						<h2 className={`text-lg sm:text-xl font-semibold ${darkModeColors.textPrimary}`}>
							About
						</h2>
						<p className={`mt-2 text-sm sm:text-base leading-relaxed ${darkModeColors.textSecondary}`}>
					...
					<div>
						...
						<ul className={`mt-2 space-y-2 text-sm sm:text-base ${darkModeColors.textSecondary}`}>
					...
					<div>
						...
						<p className={`mt-2 text-sm sm:text-base ${darkModeColors.textSecondary}`}>
